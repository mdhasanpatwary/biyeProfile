      ...
      <Container className="max-w-4xl mt-24 pb-32">
        <Card className="overflow-hidden">
          <div className="md:flex">
            ...
            <div className="md:w-1/2 p-16 flex flex-col justify-center items-start bg-background">
              <div className="space-y-8 mb-12 w-full">
                <div className="flex items-start gap-4 pb-8 border-b border-border-muted w-full">
                  <div className="w-5 h-5 rounded-none bg-foreground text-background flex items-center justify-center shrink-0 mt-0.5">
                  ...
                  <div>
                    <p className="font-mono text-[10px] uppercase tracking-widest text-foreground-muted mb-1.5 font-black">Standard</p>
                ...
                <div className="flex items-start gap-4 w-full">
                  ...
                  <div>
                    <p className="font-mono text-[10px] uppercase tracking-widest text-foreground-muted mb-1.5 font-black">Utility</p>
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <div className="flex flex-wrap justify-center sm:justify-start gap-4 mt-8">
                {[
                  ...
                  <Badge key={i} variant="outline" className="text-foreground-muted font-mono text-[10px] uppercase tracking-[0.3em] font-black px-5 py-2.5">
                    {stat}
                  </Badge>
                ))}
              </div>
