...
function Badge({ className, variant = "default", ...props }: BadgeProps) {
  ...
  return (
    <div
      className={cn(
        "inline-flex items-center rounded-none border px-3 py-1 text-[10px] font-bold uppercase tracking-widest transition-colors focus:outline-none focus:ring-2 focus:ring-foreground focus:ring-offset-2",
        variants[variant],
        className
      )}
      {...props}
