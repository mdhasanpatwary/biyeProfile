        ...
        <div className="flex items-center gap-1.5 sm:gap-3 ml-auto">
          ...
          {session?.user ? (
            ...
            <Link
              ...
              className="font-mono text-[11px] md:text-[12px] font-black uppercase tracking-[0.1em] sm:tracking-[0.2em] text-foreground border border-foreground px-3 sm:px-6 h-10 flex items-center justify-center hover:bg-foreground hover:text-background transition-all whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground focus-visible:ring-offset-4 ml-1 shrink-0"
            >
              Sign In
            </Link>
          )}
