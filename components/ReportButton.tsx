...
export function ReportButton({ biodataId }: { biodataId: string }) {
  ...
  return (
    <Button
      ...
      className={`text-[10px] font-mono font-black uppercase tracking-widest ${hasReported ? 'text-green-600' : 'text-foreground-muted hover:text-red-500 hover:bg-red-50'}`}
    >
