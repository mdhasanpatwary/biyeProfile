...
export function Footer() {
  return (
    <footer className="py-16 md:py-32 border-t border-border bg-background print:hidden">
      <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16">
        {/* Brand Column */}
        <div className="md:col-span-4 flex flex-col items-start gap-6 md:gap-8">
          ...
          <div className="mt-8 md:mt-12 text-[10px] font-mono text-foreground/25 uppercase tracking-widest">
            Established 2026. <br /> All Rights Reserved.
          </div>
        </div>

        {/* Navigation Grid */}
        <div className="md:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
