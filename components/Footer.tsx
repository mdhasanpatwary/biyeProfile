...
export function Footer() {
  return (
    <footer className="py-12 md:py-16 border-t border-border bg-background print:hidden">
      <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        <div className="md:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-10 md:gap-12">
          <div className="flex flex-col gap-6">
            <span className="font-mono text-[10px] font-black text-foreground uppercase tracking-[0.2em] mb-4">Platform</span>
          ...
          <div className="flex flex-col gap-6">
            <span className="font-mono text-[10px] font-black text-foreground uppercase tracking-[0.2em] mb-4">Institutional</span>
          ...
          <div className="flex flex-col gap-6">
            <span className="font-mono text-[10px] font-black text-foreground uppercase tracking-[0.2em] mb-4">Registry</span>
          ...
          <div className="flex flex-col gap-6">
            <span className="font-mono text-[10px] font-black text-foreground uppercase tracking-[0.2em] mb-4">Legal</span>
